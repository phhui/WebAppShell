...
public class PqWebview extends WebView {
    private IPqWebviewListener listener;
    private Context ct;
    public PqWebview(Context context) {
        super(context);
        ct=context;
    }
    public void init(IPqWebviewListener ipwl){
        listener=ipwl;
...
//        }, "myapp");
    ...
    public void registerFunc(Object obj, String name){
        this.addJavascriptInterface(obj,name);
    }
    public void callJs(String js){
        this.evaluateJavascript("javascript:"+js, new ValueCallback<String>() {
            @Override
            public void onReceiveValue(String value) {
                //此处为 js 返回的结果
                listener.onReceiveJsValue(value);
            }
        });
    }
}
